...
<?php include '../View/UI.php';?>
	...
	<section id = "section1">
		<div class="col-md-10" style="text-align: center; font-size: 60px; color:#2d2244"> Delete Product </div>
		<div class="col-md-10" style="text-align: center; font-size: 25px; color:#fbf7f7">
		<form action='../Model/delete_product_process.php' class="form_design" method="post">

			Shop ID: <select name="shop_id">
            <?php
                while ($category = mysqli_fetch_array(
					$product_list,MYSQLI_ASSOC)):;
            ?>
                <option value="<?php echo $category["product_id"];?>"><?php echo $category["product_id"];
                    ?>
                </option>
            <?php
                endwhile;
